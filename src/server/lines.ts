...
${toGothicLine({
  text: {
    got: 'Huzd þiuþe jah Giband libáináis:',
...
${toGothicLine({
  text: {
    got: 'jah gahráinei uns af allamma wamma,',
...
${toGothicLine({
  text: {
    got: 'jah nasei, Þiuþeiga sáiwalos unsara.',
...
${toGothicLine({
  text: {
    got: 'Fráuja, hulþs sijáis frawaúrhtim unsaráim.',
...
${toGothicLine({
  text: {
    got: 'Fráujinond, fragif unsibjona unsara.',
...
${toGothicLine({
  text: {
    got: 'Weiha, gaweiso jah háilei saúhtins unsara,',
...
${[
    ...
    {
      text: {
        got: 'swe ïn himina jah ana aírþái.',
...
${[
    {
      text: {
        got: 'Hláif unsarana þana sinteinan gif uns himma daga.',
...
${[
    {
      text: {
        got: 'Jah aflet uns þatei skulans sijáima,',
...
${[
    {
      text: {
        got: 'swaswe jah weis afletam þáim skulam unsaráim.',
...
${[
    {
      text: {
        got: 'Jah ni briggais uns ïn fráistubnjái,',
...
${[
    {
      text: {
        got: 'ak láusei uns af þamma ubilin.',
...
${toGothicLine({
  text: {
    got: 'du Xristáu Þiudana unsaramma Guda.',
...
${toGothicLine({
  text: {
    got: 'du ïmma Xristáu Þiudana jah Guda unsaramma.',
