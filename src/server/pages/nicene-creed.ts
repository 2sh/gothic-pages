...
content += html`<p>${[
  {
    text: {
      got: 'jah du áinamma Fraujin Ïēsu Xristau,',
...
content += html`<p>${[
  {
    text: {
      got: 'ïs warþ áuk faúr uns uf Pauntiau Peilatau ushramiþs,',
...
content += html`<p>${[
  ...
  {
    text: {
      got: 'þamma Fráujin jah Giband libáinais,',
...
content += html`<p>${[
  ...
  {
    text: {
      got: 'aikklesjōn kaþauleigai jah apaustauleigai;',
...
content += html`<p>${[
  {
    text: {
      got: 'andháitam áinai dáupeinaí du fralēta frawaúrhtē;',
...
thinking 𐌳𐌰𐌿𐌸𐌰𐌽𐌴 to mean "of the ones dead"`,
  ...
  {
    text: {
      got: 'jah libáinais anawaírþins áiwis.',
