...
<span class='verse'>${toGothicLines([{
    text: {
      got: "miþþanei galaiþ inn du imma Naþan sa praufetus, miþþanei galaiþ inn du Bersabaiai.",
...
<span class='verse'>${toGothicLines([{
    text: {
      got: "þanuh waila galeikānd þus hunsl garaihteins, sauþs jah alabrunsteis; þanuh gasaljand ana hunslastaþ Þeinana stiurans.",
