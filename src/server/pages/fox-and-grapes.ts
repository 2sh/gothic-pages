...
${toGothicLines([{
    text: {
      got: 'Sind ganohai þaiei in hindarweisein laiand jah frakunnun þatei ligiþ hindar mitaþ ize.',
      en: "There are many who pretend to despise and belittle that which is beyond their reach.",
    },
  }], info)}</i></p>`
