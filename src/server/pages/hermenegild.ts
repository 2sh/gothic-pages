...
const generator: PageGenerator = info =>
{
  ...
  article += html`<h2>${toGothicLines([{
    text: {
      got: 'Gawaurdje Weihins Gregaurjaus\nBoka 3, Haubiþ 31',
...
“eisarnam bi fotuns gabuganaim jah naudibandjom eisarneinaim gabundans” Mark 5:4`
    ...
    {
      text: {
        got: 'Swah anastodida Airmunagilds sa þiudans jugga þiudangardja airþeina frakunnan, in sakkau gabundans ligan, Guda allwaldand du gaswinþnan bidos usgiutan, jah filu mais háuhaba wulþu airþos ƕeilaƕairbaizos frakunnan, und ƕan filu is gabundans froþ ei ni wesi þatei mahtedi afnuman wairþan.',
...
ἀνοσίοις meaning “1. impious, godless; 2. sacrilegious”.`
    ...
    {
      text: {
        got: 'Iþ sa manna, saei sik Guda atgaf, fairinoda þana neƕjandan arianiskan aipiskaupu swaswe skuld was, jah afskauf hindarweisein is gasahtim gatilaim; unte þauhjabai ūtana gabundans lag, aiþþau inna stoþ in sis tulguba in mikil auhumistin fraþjis seinis.',
...
"inna ... in mis" Colossians 1:29`
    ...
    {
      text: {
        got: 'Biþeh þan sa aipiskaupus gawandida sik, sa atta arianiska auhjoda jah sunsaiw insandida andbahtos, þaiei þana þar ligandan tulgistan andhaitand Gudis afsloheina, jah þata warþ.',
        ...
        en: 'The father, at the return of the Arian prelate, understanding these news, fell into such a rage that forthwith he sent his officers of execution to put to death that most constant confessor, in the very prison where he lay which unnatural and bloody commandment was performed accordingly: ',
...
/*
Sed pro ostendenda vera ejus gloria, superna quoque non defuere miracula. Nam cœpit in nocturno silentio psalmodiæ cantus ad corpus ejusdem Regis & martyris audiri; atque ideo veraciter regis, quia & martyris.
