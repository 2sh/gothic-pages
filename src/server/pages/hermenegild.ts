...
"eisarnam bi fotuns gabuganaim jah naudibandjom eisarneinaim gabundans" Mark 5:4`
    ...
    {
      text: {
        got: 'Swah anastodida Airmunagilds sa þiudans jugga þiudangardja airþeina frakunnan, ïn sakkau gabundans ligan, ...', // omnipotent.dat/abl God.dat.abl to strengthen.gerund himself prayers.acc pour_out.inf
