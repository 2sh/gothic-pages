...
content += html`<p>${[
  {
    text: {
      got: 'Simlē wēsun fidwōr hasans leitilai,',
      en: "Once upon a time there were four little Rabbits,",
    }
  },
  {
    text: {
      got: 'jah wēsun haitanai —',
...
There's the yet to be approved neologisms *𐌱𐌰𐌲𐌼𐌰𐍅𐌿𐌻𐌻𐌰 and *𐍃𐍀𐌰𐌿𐍂𐌳𐍃`
  ...
  {
    text: {
      got: 'Báuaidēdun miþ aiþein ïzē ïn malmadriusōn',
...
*𐌼𐌰𐌻𐌼𐌰𐌳𐍂𐌹𐌿𐍃𐍉𐌽 made out of 𐌼𐌰𐌻𐌼𐌰 (sand) + 𐌳𐍂𐌹𐌿𐍃𐍉𐌽 (slope/bank)`
  ...
  {
    text: {
      got: 'undarō waúrtai faúrhōs mikilaizōs filu.',
      en: "underneath the root of a very big fir-tree.",
    },
    notes: `neologism *𐍆𐌰𐌿𐍂𐌷𐌰 for fir *furhō`
  },
...
content += html`<p>${[
  {
    text: {
      got: '"NŪ, liubans meinai", qaþ Fraujo Hasa ïn ainamma maúrgina,',
...
"𐌹̈𐌽 𐌰𐌹𐌽𐌰𐌼𐌼𐌰 𐌳𐌰𐌲𐌴," on one day Luke 5:17`
  ...
  {
    text: {
      got: '"uslaubja ïzwis ïn haiþjos aíþþau and wig gaggan,',
  ...
  {
    text: {
      got: 'ïþ gaggaiþ ïn aúrtigard Fraujins Mkgraigaur.',
...
content += html`<p>${[
  {
    text: {
      got: '"JAH NŪ afleiþiþ, jah taujaiþ ni waíht unfrōþ.',
...
𐌿𐌽𐍆𐍂𐍉𐌸𐍃: a bit too sterile perhaps but works I think`
  ...
  {
    text: {
      got: `Þan nam Fraujo Hasa tainjōn jah rignskildu ïzōs,`,
...
*𐍂𐌹𐌲𐌽𐍃𐌺𐌹𐌻𐌳𐌿𐍃 - rain shield (temporary)`
  ...
  {
    text: {
      got: `jah ïddja þaírh walþu du bakari. `,
...
PGm *bakārijaz, Gothic having inherited the -ārijaz suffix as -𐌰𐍂𐌴𐌹𐍃, 𐌱𐌰𐌺𐌰𐍂𐌴𐌹𐍃`
  ...
  {
    text: {
      got: `Baúhta ainana hlaif jah fimf basibakeinins.`,
      en: `She bought a loaf of brown bread and five currant buns.`,
    },
    notes:
      `𐌱𐌰𐌹𐍂𐌰 from baírabagms + 𐌱𐌰𐌺𐌴𐌹𐌽𐌹𐌽𐍃 𐌱𐌰𐌺𐌰𐌽+𐌴𐌹𐌽𐍃.
...
content += html`<p>${[
  {
    text: {
      got: 'FLAUPSI, Maupsi jah Kauttaun-taieil, þaiei wēsun gōdai leitilai hasans,',
      en: `FLOPSY, Mopsy, and Cotton-tail, who were good little bunnies,`,
    },
  },
  {
    text: {
      got: 'ïddjēdun and wig du lisan brēmibasja;',
      en: `went down the lane to gather blackberries;`,
    },
    notes: `*brēmibasi (n. Ja) from *brēmibasją`
  },
  {
    text: {
...
instead of 𐌿𐌱𐌹𐌻𐌰𐌱𐌰 as it may seem too harsh`
  ...
  {
    text: {
      got: 'rann suns du aúrtigard Fraujins Mkgraigaur,',
      en: `ran straight away to Mr. McGregor’s garden,`,
    },
  },
  {
    text: {
      got: 'jah þaírhïddja uf daúr!',
...
content += html`<p>${[
  ...
  {
    text: {
      got: 'JAH þan, habands ubil, ïddja suma <[parsley]> du sōkjan.',
...
content += html`<p>${[
  {
    text: {
      got: 'AÞÞAN bi andja <[cucumber]> hramōs, du ƕamma garann? Frauja Mkgraigaur!',
...
parts o-stem *hramō (“frame, rack”) and *-janą.
hramō following o-stem *skamō to attested 𐍃𐌺𐌰𐌼𐌰 => 𐌷𐍂𐌰𐌼𐌰.
...
but shouldn't be needed with the Gothic 𐌲𐌰𐍂𐌹𐌽𐌽𐌰𐌽, I think.`
  ...
  {
    text: {
      got: `ïþ ushaihlaup jah rann afar Paitrau, swaggwida raka jah hrōpida: "Gastand þiuf!"`,
...
Using *𐍂𐌰𐌺𐌰 for rake, from PGm female o-stem *rakō. Looking at 𐌱𐍉𐌺𐌰's declensions.
...
content += html`<p>${[
  ...
  {
    text: {
      got: `sniumida and allana aúrtigard,`,
  ...
  {
    text: {
      got: `untē ni gamunan wig atwandjands du daúr.`,
...
wiga gaggandans du Iairusaulwmai Mark 10:32`
  ...
  {
    text: {
      got: `Fralaus ainana skōhe ïn <[cabbages]>,`,
  ...
  {
    text: {
      got: `jah anþarana skōh ïn <[potatoes]>.`,
...
content += html`<p>${[
  {
    text: {
      got: `AFAR þatei fralaus þans, rann ana liþus fidwōrim jah ïddja snilliza,`,
...
*𐍃𐌽𐌹𐌻𐌻𐍃 from a-stem snellaz, looking at a-stem 𐌼𐌰𐌽𐌰𐌲𐍃, comparative 𐌼𐌰𐌽𐌰𐌲𐌹𐌶𐌰 => 𐍃𐌽𐌹𐌻𐌻𐌹𐌶𐌰`
  ...
  {
    text: {
      got: `swaei ïk fraþja gaþlaúhi allandjō,`,
...
fortunate 𐌰𐌿𐌳𐌰𐌲𐍃, 𐌿𐌽𐌰𐌿𐌳𐌰𐌲𐌰𐌱𐌰 following a-stem 𐌱𐌰𐌹𐍂𐌷𐍄𐌰𐌱𐌰.`
  ...
  {
    text: {
      got: `jah warþ þaírh mikila <[buttons]> ana <[jacket]> ïs gafāhans.`,
  ...
  {
    text: {
      got: `Sa was <[jacket]> blēws miþ <[buttons]> aizis, niujis filu.`,
...
content += html`<p>${[
  {
    text: {
      got: `PAITRUS þāhta sis swē fralusans, jah fralailōt tagr mikil;`,
      en: `PETER gave himself up for lost, and shed big tears;`,
    },
  },
  {
    text: {
      got: `ïþ grētos ïs wēsun gauridai sumaim <[sparrows]> qaírrjaim`,
      en: `but his sobs were overheard by some friendly sparrows,`,
    },
  },
  {
    text: {
      got: `þaiei gadrōbnandans mikilaba <[flew]> du ïmma, jah ïna bēdun ïna du usdaudjan.`,
