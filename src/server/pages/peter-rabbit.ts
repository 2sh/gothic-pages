...
There’s the yet to be approved neologisms *𐌱𐌰𐌲𐌼𐌰𐍅𐌿𐌻𐌻𐌰 and *𐍃𐍀𐌰𐌿𐍂𐌳𐍃`
    ...
    {
      text: {
        got: 'Bauaidedun miþ aiþein ize in malmadriuson',
...
“𐌹̈𐌽 𐌰𐌹𐌽𐌰𐌼𐌼𐌰 𐌳𐌰𐌲𐌴,” on one day Luke 5:17`
    ...
    {
      text: {
        got: '“uslaubja izwis in haiþjos aiþþau and wig gaggan,',
    ...
    {
      text: {
        got: 'Ubil warþ bi attan izwar jainar;',
...
𐌿𐌽𐍆𐍂𐍉𐌸𐍃: a bit too sterile perhaps but works I think`
    ...
    {
      text: {
        got: `Þan nam Hasa Fraujo tainjon jah rignskildu izos,`,
...
*𐍂𐌹𐌲𐌽𐍃𐌺𐌹𐌻𐌳𐌿𐍃 - rain shield (temporary)`
    ...
    {
      text: {
        got: `jah iddja þairh walþu du bakari.`,
...
*kauls m.A from Neolog. doc`
    ...
    {
      text: {
        got: `iþ ushaihlaup jah rann afar Paitrau, swaggwida raka jah hropida: “Gastand þiuf!”`,
...
*𐍃𐌽𐌹𐌻𐌻𐍃 from a-stem snellaz, looking at a-stem 𐌼𐌰𐌽𐌰𐌲𐍃, comparative 𐌼𐌰𐌽𐌰𐌲𐌹𐌶𐌰 => 𐍃𐌽𐌹𐌻𐌻𐌹𐌶𐌰`
    ...
    {
      text: {
        got: `swaei ik fraþja gaþlauhi allandjo,`,
