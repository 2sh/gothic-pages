...
There's the yet to be approved neologisms *𐌱𐌰𐌲𐌼𐌰𐍅𐌿𐌻𐌻𐌰 and *𐍃𐍀𐌰𐌿𐍂𐌳𐍃`
  ...
  {
    text: {
      got: 'Báuaidedun miþ aiþein ïze ïn malmadriuson',
...
*𐌼𐌰𐌻𐌼𐌰𐌳𐍂𐌹𐌿𐍃𐍉𐌽 made out of 𐌼𐌰𐌻𐌼𐌰 (sand) + 𐌳𐍂𐌹𐌿𐍃𐍉𐌽 (slope/bank)`
  ...
  {
    text: {
      got: 'undaro waúrtai faúrhos mikilaizos filu.',
...
content += html`<p>${[
  {
    text: {
      got: '"JAH NŪ afleiþiþ, jah taujaiþ ni waíht unfroþ.',
...
content += html`<p>${[
  {
    text: {
      got: `PAITRUS þāhta sis swe fralusans, jah fralailot tagr mikil;`,
      en: `PETER gave himself up for lost, and shed big tears;`,
    },
  },
  {
    text: {
      got: `ïþ gretos ïs wesun gauridai sumaim <[sparrows]> qaírrjaim`,
