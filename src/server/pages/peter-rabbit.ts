...
There's the yet to be approved neologisms *𐌱𐌰𐌲𐌼𐌰𐍅𐌿𐌻𐌻𐌰 and *𐍃𐍀𐌰𐌿𐍂𐌳𐍃`
  ...
  {
    text: {
      got: 'Baúáidedun miþ áiþein ïze ïn malmadriuson',
...
*𐌼𐌰𐌻𐌼𐌰𐌳𐍂𐌹𐌿𐍃𐍉𐌽 made out of 𐌼𐌰𐌻𐌼𐌰 (sand) + 𐌳𐍂𐌹𐌿𐍃𐍉𐌽 (slope/bank)`
  ...
  {
    text: {
      got: 'undaro waúrtái faúrhos mikiláizos filu.',
...
"𐌹̈𐌽 𐌰𐌹𐌽𐌰𐌼𐌼𐌰 𐌳𐌰𐌲𐌴," on one day Luke 5:17`
  ...
  {
    text: {
      got: '"usláubja ïzwis ïn háiþjos aíþþáu and wig gaggan,',
  ...
  {
    text: {
      got: 'ïþ gaggáiþ ïn aúrtigard Fráujins Mkgraigaur.',
      en: "but don’t go into Mr. McGregor’s garden.",
    },
  },
  {
    text: {
      got: 'Ubil warþ bi attan ïzwar jáinar;',
...
be it unto me 𐍅𐌰𐌹𐍂𐌸𐌰𐌹 𐌼𐌹𐍃 Luke 1:38.`
  ...
  {
    text: {
      got: 'ïs was ïn mat fram Fráujon Mkgraigaur galagiþs."',
...
𐌿𐌽𐍆𐍂𐍉𐌸𐍃: a bit too sterile perhaps but works I think`
  ...
  {
    text: {
      got: `Þan nam Fráujo Hasa táinjon jah rignskildu ïzos,`,
...
PGm *bakārijaz, Gothic having inherited the -ārijaz suffix as -𐌰𐍂𐌴𐌹𐍃, 𐌱𐌰𐌺𐌰𐍂𐌴𐌹𐍃`
  ...
  {
    text: {
      got: `Baúhta áinana hláif jah fimf basibakeinins.`,
...
article += html`<p>${[
  ...
  {
    text: {
      got: 'ÏÞ Paitrus, saei was ufarháusjands filu,',
...
instead of 𐌿𐌱𐌹𐌻𐌰𐌱𐌰 as it may seem too harsh`
  ...
  {
    text: {
      got: 'rann suns du aúrtigard Fráujins Mkgraigaur,',
...
but shouldn't be needed with the Gothic 𐌲𐌰𐍂𐌹𐌽𐌽𐌰𐌽, I think.`
  ...
  {
    text: {
      got: 'Fráuja Mkgraigaur was ana handum jah kniwam ïs ussatjands jugga <[cabbages]>,',
  ...
  {
    text: {
      got: `ïþ ushaíhláup jah rann afar Paitráu, swaggwida raka jah hropida: "Gastand þiuf!"`,
...
article += html`<p>${[
  ...
  {
    text: {
      got: `unte ni gamunan wig atwandjands du daúr.`,
...
wiga gaggandans du Iairusaulwmai Mark 10:32`
  ...
  {
    text: {
      got: `Fraláus áinana skohe ïn <[cabbages]>,`,
...
*𐍃𐌽𐌹𐌻𐌻𐍃 from a-stem snellaz, looking at a-stem 𐌼𐌰𐌽𐌰𐌲𐍃, comparative 𐌼𐌰𐌽𐌰𐌲𐌹𐌶𐌰 => 𐍃𐌽𐌹𐌻𐌻𐌹𐌶𐌰`
  ...
  {
    text: {
      got: `swaei ïk fraþja gaþlaúhi allandjo,`,
  ...
  {
    text: {
      got: `wáinei unáudagaba ni garunni ïn <[gooseberry]> nati,`,
...
fortunate 𐌰𐌿𐌳𐌰𐌲𐍃, 𐌿𐌽𐌰𐌿𐌳𐌰𐌲𐌰𐌱𐌰 following a-stem 𐌱𐌰𐌹𐍂𐌷𐍄𐌰𐌱𐌰.`
  ...
  {
    text: {
      got: `Sa was <[jacket]> blews miþ <[buttons]> áizis, niujis filu.`,
...
article += html`<p>${[
  ...
  {
    text: {
      got: `ïþ gretos ïs wesun gáuridái sumáim <[sparrows]> qaírrjáim`,
      en: `but his sobs were overheard by some friendly sparrows,`,
    },
  },
  {
    text: {
      got: `þaiei gadrobnandans mikilaba <[flew]> du ïmma, jah ïna bedun ïna du usdáudjan.`,
